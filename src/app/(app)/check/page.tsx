  ...
  return (
    <div className="space-y-4">
      ...
      <div className="h-[100px] overflow-y-auto border-y border-edge p-2">
        <p>
          Lorem 555: Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          Pellentesque habitant morbi tristique senectus et netus et malesuada
          fames ac turpis egestas. Sed non justo at velit tristique dignissim.
          Integer varius, lacus ut congue convallis, nunc lorem posuere nibh,
          non pharetra lorem dolor sed augue. Curabitur suscipit, sem in
          viverra volutpat, risus metus congue nulla, vitae luctus purus lorem
          et mi. Aenean at sapien sed nibh suscipit faucibus. Cras vulputate
          finibus lorem, sed mattis lorem feugiat id.
        </p>
      </div>
      ...
      <section className="screen-line-before screen-line-after">
        <div className="p-8 space-y-6 font-mono">
          ...
          <section className="mb-8 screen-line-after screen-line-before h-56 overflow-auto overflow-x-hidden ">
